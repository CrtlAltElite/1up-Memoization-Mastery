...
time_no_memo = timeit.timeit("expensive_calculation_no_memo(30)", globals=globals(), number=1000)
print(f"Time taken for expensive_calculation_no_memo: {time_no_memo}")

# Benchmark for expensive_calculation_with_memo
time_with_memo = timeit.timeit("expensive_calculation_with_memo(30)", globals=globals(), number=1000)
